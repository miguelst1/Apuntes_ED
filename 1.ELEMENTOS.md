...
- Tipos de __lenguajes imperativos__:
  ...
  - Multiparadigma: C++, Javascript apuntes: se utilizan varios paradigmas
...
- Código binario
- Ensamblador apuntes: solo para algunos drivers y arranque del sistema
- Lenguajes estructurados 
- Lenguajes orientados a objetos apuntes: permiten programar aplicaciones complejas
